...
class MasterAgentResponse(BaseModel):
    ...
    allocation_pct: int = Field(description="Tỷ trọng phân bổ vốn đề xuất trong danh mục (từ 0 đến 100%)")
    volume_percent: int = Field(description="Tỷ trọng giải ngân cụ thể cho đợt lệnh này (%)")
